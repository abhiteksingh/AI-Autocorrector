...
## 🚀 Overview
Unlike standard spellcheckers, this tool uses **Qwen 3.6** to understand user intent. It doesn't just fix typos; it re-writes text based on a selected tone (Professional, Casual, Creative, or Formal) and provides structured feedback on why changes were made.

## 🛠️ Tech Stack
- **Frontend:** React.js, Vite, Tailwind CSS (Hosted on Vercel)
- **Backend:** Python, FastAPI, LangChain (Hosted on Render)
- **AI Brain:** Qwen 3.6-27B via Groq API
